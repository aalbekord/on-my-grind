    ...
    return (
        <div>
            ...
            <form className="container">
              <div className={`mini-container ${correct_temp}`}>
                <h3>Temperature</h3>
              ...
              <div className={`mini-container ${correct_syrup}`}>
                <h3>Syrup</h3>
              ...
              <div className={`mini-container ${correct_milk}`}>
                <h3>Milk</h3>
              ...
              <div className={`mini-container ${correct_blended}`}>
                <h3>Blended</h3>
